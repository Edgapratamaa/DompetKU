...
namespace kantong.Model
{
    public class PengeluaranModel
    {
        ...
        public bool TambahPengeluaran(decimal jumlah, string kategori, string deskripsi, DateTime tanggal)
        {
            string query = "INSERT INTO pengeluaran (jumlah, kategori, deskripsi, tanggal) VALUES (@jumlah, @kategori, @deskripsi, @tanggal)";
